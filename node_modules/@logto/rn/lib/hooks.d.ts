...
export declare const useLogto: () => {
    ...
    getAccessTokenClaims: (resource?: string | undefined) => Promise<import("@logto/client").AccessTokenClaims>;
    ...
    getOrganizationTokenClaims: (organizationId: string) => Promise<import("@logto/client").AccessTokenClaims>;
    ...
    getIdTokenClaims: () => Promise<import("@logto/client").IdTokenClaims>;
    ...
    fetchUserInfo: () => Promise<import("@logto/client").UserInfoResponse>;
};
